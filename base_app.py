...
# Load your raw data
train_data = pd.read_csv("classification-predict-streamlit-template\resources\train2.csv")
test_data = pd.read_csv("classification-predict-streamlit-template\resources\test_with_no_labels.csv")
